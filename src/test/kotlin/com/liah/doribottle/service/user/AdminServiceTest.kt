...
class AdminServiceTest : BaseServiceTest() {
    ...
    fun update() {
        ...
        adminService.update(admin.id, "updated", "updated", Role.MACHINE_ADMIN, null, null, null, null)
        clear()
    ...
    fun updateException() {
        ...
        val exception = assertThrows<IllegalArgumentException> {
            adminService.update(admin.id, "updated", "updated", Role.USER, null, null, null, null)
        }
