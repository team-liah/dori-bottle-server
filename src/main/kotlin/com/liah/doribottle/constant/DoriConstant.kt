...
object DoriConstant {
     ...
     */
    val SAVE_INVITE_REWARD_AMOUNTS_MAP =
        mapOf(
            5 to 5L,
            10 to 10L,
            25 to 30L,
    ...
    const val RENTAL_MACHINE_DEFAULT_IMAGE_URL = "https://doribottle-asset.s3.ap-northeast-2.amazonaws.com/static/machine-rental.png"
    const val RETURN_MACHINE_DEFAULT_IMAGE_URL = "https://doribottle-asset.s3.ap-northeast-2.amazonaws.com/static/machine-return.png"
}
